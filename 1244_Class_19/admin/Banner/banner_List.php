				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Banner List

							</h5>
							<div class="heading-elements">
								<ul class="icons-list">
									<li style='margin-right: 0px;'><a href="banner_create.php" class="btn btn-primary add-new">Add new</a></li>
									...
									?>
										...
										<tr>
											...
											<td class="text-center">
												<a href="banner_update.php?banner_id=<?php echo $banner['id']; ?>">
